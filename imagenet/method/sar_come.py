...
# @torch.jit.script Kyle: Comment out the decorator from The original COME 
# Keep this function out of TorchScript; JIT combined with SAM can cause numerical overflow here.
